...
from workflow import workflows,shuffle_genes_across_samples
...
def main(
    ...
    for i in range(700,1000):
        ...
        for epoch in range(epochs):
            for phase in ['train', 'valid']:
                epoch_loss, all_metrics = workflows[phase](
                    device, net, criterion, optimizer, tqdm.tqdm(data_loaders[phase]), data_loaders, phase,model_name,gene_size,i,scaler=scaler)
        ...
        if data_loaders.get('test', None):
            workflows['test'](device, net, data_loaders['test'], model_name,writer,gene_size,i)
        else:
            workflows['test'](device, net, data_loaders['valid'],model_name,writer,gene_size,i)
...
if __name__ == '__main__':
    ...
    main( train_dir_prefix=datetime_now_str(),
      ...
      dataset_dir_path=r"/pub/data/gaoss/New_Multi/code/MAGIC_prs_20/75_HM/",#"/pub/data/gaoss/New_Multi/code/MAGIC_prs_20/75_HM/",
      snps_size_dir=r"/pub/data/gaoss/New_Multi/code/MAGIC_prs_20/75_HM/HM_gene_size.txt",#"/pub/data/gaoss/New_Multi/code/MAGIC_prs_20/75_HM/HM_gene_size.txt",
      output_dir=r"/pub/data/gaoss/New_Multi/code/Interaction_premutation/75_permunation_1000_5/",#"/pub/data/gaoss/New_Multi/code/Interaction_premutation/75_permunation_1000_5/",
      snp_number=924,
      batch_size=32,
