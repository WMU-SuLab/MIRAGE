...
def train_valid_test_split(
    ...
    # label data
    # attention: The dtype here is to prevent id from being converted to scientific notation
...
if __name__ == '__main__':
    train_valid_test_split(label_data_path=r"/pub/data/gaoss/New_Multi/code/SuLabCohort/label/qc_one_eye_high_myopia_merge.csv",
                           gene_data_dir_path=r"/pub/data/gaoss/New_Multi/code/One-hot/SuLabCohort/common-rare/trans_snp/r2_0.4_p_1/",
                           image_data_dir_path='',#r"/pub/data/gaoss/data/SuLabCohort/image/all_qc/",
                           dataset_divide_dir=r"/pub/data/gaoss/New_Multi/code/SuLabCohort/",
